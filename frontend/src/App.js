...
import { ChevronDown, ShoppingBag, Instagram, Minus, Plus, X, Egg, Check } from "lucide-react";
...
const exclusiveCookies = [
  ...
  },
  {
    ...
    price: 89,
    weight: "65g",
    description: "Double chocolate dough, 72% dark chips, finished with a pinch of fleur de sel.",
  ...
  },
  {
    ...
    price: 109,
    weight: "65g",
    description: "Biscoff spread swirled into the dough, whole Biscoff pieces pressed on top. Caramel, spice, and warmth.",
  ...
  },
  {
    ...
    price: 109,
    weight: "65g",
    description: "A pure Nutella core hidden inside a deep chocolate cookie. Break it open. Watch it pour.",
    image: "https://images.unsplash.com/photo-1741542164717-5f5f13cbfcd2?w=900&q=85",
  },
];

const allRegularCookies = [
  alwaysAvailableCookies[0],
  ...exclusiveCookies,
];

const processSteps = [
  {
    step: "01", title: "Browning", subtitle: "Where depth begins",
    body: "We slowly brown European-style butter until it turns deep amber and fills the kitchen with the scent of toasted hazelnuts.",
    time: "~15 min",
    image: "https://images.unsplash.com/photo-1758874960608-f0d7f38d9846?w=900&q=85",
  },
  {
    step: "02", title: "Mixing", subtitle: "Art in every fold",
    body: "Cold eggs, two types of sugar, still-warm browned butter. The fold is everything — overwork it and you lose the magic.",
    time: "~20 min",
    image: "https://images.unsplash.com/photo-1772915516557-2d57f94b0bd0?w=900&q=85",
  },
  {
    step: "03", title: "24 hr Chilling", subtitle: "The wait is the recipe",
    body: "The dough rests in cold for a full 24 hours. Flavours meld. Moisture redistributes. Patience is the technique.",
    time: "24 hours",
    image: "https://images.unsplash.com/photo-1687549181635-e795cefee8b5?w=900&q=85",
  },
  {
    step: "04", title: "Baking", subtitle: "Golden hour",
    body: "Pulled two minutes before they look done. They finish cooking on the hot pan — soft centre, barely-there crisp edge.",
    time: "~11 min",
    image: "https://images.unsplash.com/photo-1737674879060-7be2f5198aab?w=900&q=85",
  },
];
...
const Navbar = ({ cartCount, onCartClick }) => {
  ...
  return (
    ...
    >
      <span className="sundays-logo text-xl md:text-2xl tracking-[0.35em] text-[#FDFBF7]">
        SUNDAYS
      </span>
      ...
      <div className="flex items-center gap-2 md:gap-6">
        <button
          ...
          className="hidden md:block text-xs uppercase tracking-[0.2em] hover:opacity-100 transition-opacity"
          style={{ color: C.muted, fontFamily: "Manrope, sans-serif", opacity: 0.7 }}
        >
          Process
        </button>
        <button
        ...
        <a
          href="https://www.instagram.com/sundays.hyd/"
          target="_blank"
    ...
    <section ref={ref} data-testid="hero-section" className="relative h-screen overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: videoY }}>
        ...
        <div className="absolute inset-0"
          style={{ background: "linear-gradient(to bottom, rgba(10,20,14,0.45) 0%, rgba(10,20,14,0.35) 50%, rgba(10,20,14,0.95) 100%)" }}
        />
      </motion.div>
        ...
        {[
          ...
          <motion.div key={s.label}
            ...
            <div className="mt-2 text-xs uppercase tracking-[0.2em]"
              style={{ color: C.muted, fontFamily: "Manrope, sans-serif" }}>{s.label}</div>
          </motion.div>
        ))}
      </div>
    </div>
...
const ProcessStep = ({ step, index }) => {
  ...
  return (
    <motion.div ref={ref} data-testid={`process-step-${step.step}`}
      ...
      <motion.div className={`relative overflow-hidden ${!isEven ? "lg:order-2" : ""}`}
        style={{ y: imgY, opacity: imgOpacity }}>
        <img src={step.image} alt={step.title} className="w-full object-cover"
          style={{ height: "480px", filter: "brightness(0.82)" }} loading="lazy" />
        <div className="absolute inset-0"
          style={{ background: "linear-gradient(to bottom, transparent 45%, rgba(10,20,14,0.5) 100%)" }} />
      ...
      <motion.div className={!isEven ? "lg:order-1" : ""}
        ...
        <span className="text-xs uppercase tracking-[0.35em]"
          style={{ color: C.gold, fontFamily: "Manrope, sans-serif" }}>Step {step.step}</span>
        <h3 className="sundays-heading mt-4 text-[#FDFBF7] leading-none"
          style={{ fontSize: "clamp(2.8rem, 5vw, 4rem)" }}>{step.title}</h3>
  ...
  <section id="process-section" data-testid="process-section" className="py-36 md:py-52" style={{ background: C.surface }}>
    <div className="px-6 md:px-16 lg:px-32 max-w-7xl mx-auto">
      <div className="mb-24">
        ...
        <motion.h2 className="sundays-heading text-[#FDFBF7]"
          style={{ fontSize: "clamp(2.5rem, 5.5vw, 4.8rem)" }}
...
const CookieCard = ({ cookie, index, onAddToCart }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden" style={{ height: "260px" }}>
        <motion.img src={cookie.image} alt={cookie.name}
        ...
        <div className="absolute top-4 right-4 px-3 py-1.5"
          style={{ background: "rgba(10,20,14,0.85)", border: `1px solid ${C.border}` }}>
      ...
      {/* Content */}
      <div className="p-6">
        <p className="text-xs uppercase tracking-[0.25em] mb-1.5"
          style={{ color: C.gold, fontFamily: "Manrope, sans-serif" }}>
          {cookie.flavor}
        </p>
        ...
        {/* Quantity Selector (not for minis) */}
        {!cookie.isMini && (
          <div className="mb-5">
            <p className="text-[11px] uppercase tracking-[0.15em] mb-2.5"
              style={{ color: C.muted, fontFamily: "Manrope, sans-serif" }}>
              Quantity
            </p>
            <div className="flex gap-2">
              {QTY_OPTIONS.map((q) => (
                <button
                  key={q}
                  data-testid={`qty-${cookie.id}-${q}`}
                  onClick={() => setQty(q)}
                  className="flex-1 py-2 text-sm font-semibold tracking-wide transition-all duration-200"
                  style={{
                    fontFamily: "Manrope, sans-serif",
                    background: qty === q ? C.gold : "transparent",
                    color: qty === q ? C.bg : C.muted,
                    border: `1px solid ${qty === q ? C.gold : C.border}`,
                  }}
                >
                  {q}
                </button>
            ...
            {qty > 1 && (
              <p className="mt-2 text-sm" style={{ color: C.gold, fontFamily: "Manrope, sans-serif" }}>
                {"\u20B9"}{cookie.price * qty}
              </p>
            )}
          </div>
        ...
        <motion.button
          onClick={handleAdd}
          data-testid={`add-cart-${cookie.id}`}
    ...
    <div className="px-6 md:px-16 lg:px-32 max-w-7xl mx-auto">
      ...
      <motion.div className="mb-20 md:mb-28" data-testid="section-always-available"
        ...
        <div className="flex items-center gap-4 mb-8 flex-wrap">
          <h3 className="text-sm font-semibold tracking-[0.22em] uppercase"
            style={{ color: C.muted, fontFamily: "Manrope, sans-serif" }}>Always Available</h3>
          <span className="text-xs uppercase tracking-[0.18em] px-3 py-1.5"
            style={{ color: C.gold, border: `1px solid ${C.border}`, fontFamily: "Manrope, sans-serif" }}>
            Fresh Daily
          </span>
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
          {alwaysAvailableCookies.map((cookie, i) => (
            <CookieCard key={cookie.id} cookie={cookie} index={i} onAddToCart={onAddToCart} />
          ))}
        </div>
      </motion.div>
      ...
      <motion.div className="mb-8" data-testid="section-exclusive"
        ...
        <div className="flex items-center gap-4 mb-8 flex-wrap">
          <h3 className="text-sm font-semibold tracking-[0.22em] uppercase"
            style={{ color: C.muted, fontFamily: "Manrope, sans-serif" }}>Exclusive Flavours</h3>
          <span className="text-xs uppercase tracking-[0.18em] px-3 py-1.5"
            style={{ color: C.gold, border: `1px solid ${C.border}`, fontFamily: "Manrope, sans-serif" }}>
            Limited
          </span>
...
const AssortedBuilder = ({ onAddAssorted }) => {
  ...
  return (
    <section data-testid="assorted-section" className="py-36 md:py-44" style={{ background: C.surface }}>
      <div className="px-6 md:px-16 lg:px-32 max-w-7xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }}
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-sm font-bold px-3 py-1"
                style={{
                  fontFamily: "Manrope, sans-serif",
                  color: totalSelected === 6 ? C.bg : C.gold,
                  background: totalSelected === 6 ? C.gold : "transparent",
                ...
                return (
                  <div key={cookie.id} data-testid={`assorted-pick-${cookie.id}`}
                    ...
                    <img src={cookie.image} alt={cookie.name}
                      className="w-14 h-14 object-cover shrink-0" style={{ filter: "brightness(0.85)" }} />
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-[#FDFBF7] truncate" style={{ fontFamily: "Manrope, sans-serif" }}>
                        {cookie.name}
                      </p>
                      <p className="text-xs" style={{ color: C.muted, fontFamily: "Manrope, sans-serif" }}>
                        {cookie.flavor}
                      </p>
                    </div>
            ...
            <motion.button
              ...
              style={{
                fontFamily: "Manrope, sans-serif",
                background: totalSelected === 6 ? C.gold : "rgba(201,168,76,0.15)",
                color: totalSelected === 6 ? C.bg : "rgba(201,168,76,0.4)",
                cursor: totalSelected === 6 ? "pointer" : "not-allowed",
              }}
...
const PromoSection = () => (
  <section data-testid="promo-section" className="py-24 md:py-32 px-6 md:px-16 lg:px-32" style={{ background: C.bg }}>
    <motion.div className="max-w-3xl mx-auto text-center"
      ...
      <h3 className="sundays-heading text-[#FDFBF7] leading-tight"
      ...
      <p className="mt-5 text-base font-light max-w-lg mx-auto leading-relaxed"
        ...
        <a href="https://www.instagram.com/sundays.hyd/" target="_blank" rel="noopener noreferrer"
          className="inline-flex items-center mx-1 font-medium hover:underline" style={{ color: C.gold }}>
          @sundays.hyd
        </a>
      ...
      <div className="flex flex-col lg:flex-row items-start justify-between gap-16 lg:gap-24">
        ...
        <motion.div className="shrink-0"
          ...
          <p className="text-xs uppercase tracking-[0.3em] mb-3"
            style={{ color: C.muted, fontFamily: "Manrope, sans-serif" }}>Delivery only</p>
          <p className="text-sm font-light leading-relaxed max-w-xs"
            style={{ color: "rgba(253,251,247,0.4)", fontFamily: "Manrope, sans-serif" }}>
            Order on the site. We bake fresh and deliver to your door. Confirmation via WhatsApp.
          </p>
        </motion.div>
      </div>
...
export default function App() {
  ...
  const cartCount = cart.reduce((sum, item) => sum + (item.isAssorted ? 1 : 1), 0);
  ...
  const updateCartQty = useCallback((cookieId, qty) => {
    setCart((prev) =>
      prev.map((c) =>
        c.cookieId === cookieId && !c.isAssorted
  ...
  const handleOrder = async (customerInfo) => {
    ...
    const payload = {
      ...
      items: orderItems,
      assorted_boxes: assortedBoxes.length,
      assorted_selections: assortedSelections,
      total: cartTotal,
    ...
    try {
      ...
      toast.success("Order placed successfully!", { description: "We'll confirm via WhatsApp shortly." });
    } catch {
  ...
  return (
    <div style={{ background: C.bg }}>
      <Toaster
        ...
        position="top-right"
        toastOptions={{
          style: { background: C.surface, border: `1px solid ${C.border}`, color: C.text, fontFamily: "Manrope, sans-serif" },
        }}
      />
        ...
        {orderSuccess && (
          ...
          >
            <motion.div className="max-w-md w-full text-center p-10"
              ...
              <h3 className="sundays-heading text-2xl text-[#FDFBF7] mb-3">Order Placed!</h3>
              <p className="text-sm font-light leading-relaxed mb-8"
                style={{ color: "rgba(253,251,247,0.6)", fontFamily: "Manrope, sans-serif" }}>
                Thank you for your order. We'll reach out on WhatsApp to confirm delivery details.
                Fresh batch coming your way!
              </p>
              <motion.button
                onClick={() => setOrderSuccess(false)}
                data-testid="order-success-close"
                className="px-8 py-3 text-sm font-bold tracking-[0.12em] uppercase text-[#0A140E]"
                style={{ background: C.gold, fontFamily: "Manrope, sans-serif" }}
                whileHover={{ background: C.goldHover }}
                whileTap={{ scale: 0.97 }}
              >
