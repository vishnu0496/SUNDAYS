...
const PRODUCTS: Product[] = [
  {
    ...
    description: 'Mix any 3 regular cookies from Double Chocolate and Oreo Strong.',
  ...
  },
  {
    ...
    description: 'Mix any 6 regular cookies. Best-value box for the two-flavor menu.',
  ...
  },
  {
    ...
    flavor: '3 big + 12 bites',
    description: 'First-order combo with regular cookies plus Chocolate Chip Bites.',
  ...
  },
  {
    ...
    flavor: '6 big + 12 bites',
    description: 'Gifting-friendly combo with big cookies and Chocolate Chip Bites.',
  ...
  {
    id: 'chocolate-chip-bites-24',
    name: PRODUCT_NAMES.mini24,
    flavor: '24 chocolate chip bites',
    description: 'Classic chocolate chip bites for sharing. Standalone only for nearby orders.',
  ...
  {
    id: 'atta-jaggery-almond-bites-24',
    name: PRODUCT_NAMES.attaJaggery24,
    flavor: '24 atta jaggery almond bites',
    description: 'Whole wheat bites with jaggery, almonds, coconut, and warm spices.',
