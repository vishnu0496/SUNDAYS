  ...
  return (
    <section id="story" className="py-section bg-deep-forest relative">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        ...
        >
          <p>
            SUNDAYS started as a simple obsession: finding a cookie in Hyderabad that felt rich, memorable, and worth slowing down for. So I started baking. Batch after batch, tweak after tweak, until one Sunday afternoon I pulled out a tray that stopped everyone in the room.
          </p>
          <p>
