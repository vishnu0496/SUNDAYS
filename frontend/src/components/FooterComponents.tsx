  ...
  return (
    <footer className="py-20 bg-forest border-t border-gold/10">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex justify-center flex-wrap gap-12 mb-16 text-[10px] tracking-[0.2em] uppercase font-bold text-cream/40">
          ...
          <button 
            ...
            className="hover:text-gold transition-colors text-[10px] tracking-[0.2em] uppercase font-bold text-cream/40"
          >
            Ritual Guide
          </button>
